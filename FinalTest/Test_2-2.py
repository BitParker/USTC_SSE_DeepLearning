...
class Model(nn.Module):
    def __init__(self):
        ...
        self.conv1_192 = nn.Conv2d(1, 4, 3, padding=1)  # 输入1个通道，输出4个通道，3*3卷积，填充1
        self.bn1_192 = nn.BatchNorm2d(4)
        self.conv2_192 = nn.Conv2d(4, 8, 3, padding=1)
        self.bn2_192 = nn.BatchNorm2d(8)
        self.conv3_192 = nn.Conv2d(8, 8, 3, padding=1)
...
print(f"Time: {training_time} seconds")
